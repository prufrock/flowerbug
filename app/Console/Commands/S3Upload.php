...
class S3Upload extends Command
{
     ...
     * @var string
     */
    protected $signature = 's3:upload '.'{bucket : The name of the bucket to upload to.} '.'{path-to-destination : The name of the file to upload to.} '.'{content-type : The content type of the file.} '.'{--z|gzip : compress the file, upload it and set content encoding.} '.'{--p|public : make the file public.}'.'{--d|dry-run : Shows what would have been uploaded.}'.'{--debug : Show debug output.}';
